...
function [Nf, Nbnd, qs, Nqs] = getPopForward2(t, q, fn, otherPms, idq)

% Assumptions and modifications
% - includes case 7 and a boolean to get the distribution of N(t)
...
% N(t) distribution data
qs = cell(1, length(idq));
Nqs = cell(1, length(idq));
...
for i = 1:lent
     ...
     % Distributions for output at certain time points
     if any(i == idq)
         j = j+1;
         qs{j} = q;
         Nqs{j} = Nq;
