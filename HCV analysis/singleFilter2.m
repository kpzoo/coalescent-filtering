...
% Booleans to control functionality and tree and MBE use
tic;
plotindiv = 1;
getTree = 0;
linBool = 0;
...
fnstr = {'x_1e^-x_2t', 'x_1sin(x_2t + x_3) + x_4', 'x_1',...
    'logistic growth', 'piecewise exponential', 'piecewise exponential'};
...
if fnid == 5 || 6
    ...
    % Get population optimal and bounds from last posterior and TMRCA
