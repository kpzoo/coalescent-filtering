...
% - removed batch and MSE calc and simplified
...
[xhat, Nhat, lamhat, lam, N, tn, statsStruc, qn] = snyderHetero2(fn, q0, events);
tnmin = min(tn);
tnmax = max(tn);
tnlen = length(tn);
