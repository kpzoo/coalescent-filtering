...
% Functional form to do several population functions in batch
function [mse_t, param, paramhat, n, M, tIter, fn, C, tavgIter] = batchMV2Fn(fnid, M, mi)
...
switch(fnid)
    ...
    case 5
        ...
        minSpace = [1000*n 0.1 10 100];
        maxSpace = [2000*n 0.75 50 150];
end
...
%     save(['batch_' num2str(numRV) '_' num2str(fnid) '_' num2str(M)], 'mse_t', 'param', 'paramhat',...
%         'n', 'M', 'tIter', 'fn', 'C');
